...
const Container = styled.div`
  ...
  border-radius: 2px;
  background-color: ${props => (props.isDropDisabled ? 'lightgrey' : 'white')};
  display: flex;
...
const TaskList = styled.div`
  ...
  background-color: ${props => (props.isDropDisabled ? 'lightgrey' : props.isDraggingOver ? 'skyblue' : 'inherit')};
  flex-grow: 1;
  min-height: 100px;
`;
    ...
    render() {
        ...
        return (
            <Draggable draggableId={this.props.column.id} index={this.props.index}>
                {(provided) => (
                    <Container {...provided.draggableProps} ref={provided.innerRef} isDropDisabled={isDropDisabled}>
